...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { data_nascimento: @pessoa.data_nascimento, documento: @pessoa.documento, nome: @pessoa.nome } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { data_nascimento: @pessoa.data_nascimento, documento: @pessoa.documento, nome: @pessoa.nome } }
