...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { custo_mensal: @animal.custo_mensal, nome: @animal.nome } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { custo_mensal: @animal.custo_mensal, nome: @animal.nome } }
